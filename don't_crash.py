...
def crash(x,y):
    ...
    while True:
        ...
        Label("Tip: Hit the police car with missile",150,470,30,brightblue)
        Label("can earn a bonus score!", 210, 510, 30, brightblue)
...
def gameloop():
    ...
    while True:
        ...
        if busy > 600:
            ...
            busx = random.randrange(100,700-72)
            score += 1
        while (bluecarx < busx < bluecarx + 67 or bluecarx < busx+72 <bluecarx + 67 or bluecarx < busx+36 <bluecarx + 67) or (policecarx < busx < policecarx + 83 or policecarx < busx+72 < policecarx + 83 or policecarx <  busx+36 < policecarx + 83) or (redcarx < busx < redcarx + 69 or redcarx < busx+72 < redcarx + 69 or redcarx < busx+36 < redcarx + 69):
            busx = random.randrange(100,700-72)
        ...
        if bluecary > 600:
            ...
            bluecarx = random.randrange(100,700-67)
            score += 1
        while (busx < bluecarx < busx+72 or busx < bluecarx + 67 < busx+72 or busx < bluecarx+33.5 < busx + 72) or (policecarx < bluecarx < policecarx + 83 or policecarx < bluecarx+67 < policecarx + 83 or policecarx < bluecarx+33.5 < policecarx + 83) or (redcarx < bluecarx < redcarx + 69 or redcarx < bluecarx+67 < redcarx + 69 or redcarx < bluecarx+33.5 < redcarx + 69):
            bluecarx = random.randrange(100, 700 - 67)
        ...
        if policecary > 600:
            ...
            policecarx = random.randrange(100,700-83)
            score += 1
        while (busx < policecarx < busx + 72 or busx < policecarx+83 < busx + 72 or busx < policecarx+83/2 < busx + 72) or (bluecarx < policecarx < bluecarx + 67 or bluecarx < policecarx+83 < bluecarx + 67 or bluecarx < policecarx+83/2 < bluecarx + 67) or (redcarx < policecarx < redcarx + 69 or redcarx < policecarx+83 < redcarx + 69 or redcarx < policecarx+83/2 < redcarx + 69):
            policecarx = random.randrange(100, 700 - 83)
        ...
        if redcary > 600:
            ...
            redcarx = random.randrange(100, 700 - 69)
            score += 1
        while (busx < redcarx < busx + 72 or busx < redcarx+69 < busx + 72 or busx < redcarx+69/2 < busx + 72) or (bluecarx < redcarx < bluecarx + 67 or bluecarx < redcarx+69 < bluecarx + 67 or bluecarx < redcarx+69/2 < bluecarx + 67) or (policecarx < redcarx < policecarx + 83 or policecarx <  redcarx+69 < policecarx + 83 or policecarx < redcarx+69/2 < policecarx + 83):
            redcarx = random.randrange(100, 700 - 69)
